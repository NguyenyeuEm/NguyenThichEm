...
if worldMap[placeId] then
    ...
    game.Players.LocalPlayer:Kick("Only Support BloxKid")
end
repeat
    wait()
...
Window = Fluent:CreateWindow({
    Title = "Banana Cat Hub/Blox Fruit [Free Fire] By NguyenDz",
    SubTitle = "skid",
    TabWidth = 155,
    Size = UDim2.fromOffset(532, 330),
    Acrylic = false, 
    Theme = "Dark",
...
Main:AddButton({
    ...
    Callback = function()
        pcall(function()
            setclipboard("https://discord.gg/y3J2bjyUYE")
        end)
    end
})
Main:AddParagraph({
...
Toggle = Get:AddToggle("Toggle", {Title = "Auto Get Cursed Dual Katana ", Description = "Teleport To Claim Cursed Dual Katana", Default = false })
Toggle:OnChanged(function(Value)
...
game.StarterGui:SetCore("SendNotification", {
    Title = "Yes Or No";
    Text = "Do You Want To Clear Config?";
...
Frame.Name = "them lon qua cac chau oi"
